...
public class BlockEngineeredHexoriumBlock extends HexBlockReinforceable
{
	...
	{
		super("engineered_hexorium_block_" + color.name, color == EHexColors.RAINBOW ? Optional.empty() : Optional.of(new HexStateMapper("engineered_hexorium_block")), HexCreativeTabs.tabDecorative, Material.IRON, color.color, HexFilters.CONTAINS_GLOW);
