...
public class BlockFramedHexoriumBlock extends HexBlockReinforceable
{
	...
	{
		super("framed_hexorium_block_" + color.name, color == EHexColors.RAINBOW ? Optional.empty() : Optional.of(new HexStateMapper("framed_hexorium_block")), HexCreativeTabs.tabDecorative, Material.IRON, color.color, HexFilters.CONTAINS_GLOW);
