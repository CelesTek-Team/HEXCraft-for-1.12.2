...
{
	public BlockFramedHexoriumBlock(EHexColor color)
	{
		super("framed_hexorium_block_" + color.name, HexCreativeTabs.tabDecorative, Material.IRON, color);
	...
	{
		return this.color == EHexColor.RAINBOW ? Optional.empty() : Optional.of(new HexStateMapper("framed_hexorium_block"));
	}
