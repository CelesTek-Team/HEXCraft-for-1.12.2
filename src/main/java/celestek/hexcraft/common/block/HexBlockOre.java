...
public class HexBlockOre extends HexBlock
{
	...
	public HexBlockOre(String name, Optional<HexStateMapper> mapper, Drop drop, Optional<Predicate<String>> filter)
	{
		super(name, mapper, HexCreativeTabs.tabComponents, Material.ROCK, EHexColors.GRAY.color, filter);
		this.setHardness(3F);
