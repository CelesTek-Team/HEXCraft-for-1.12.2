...
{
	public BlockGlowingHexoriumGlass(EHexColors color)
	{
		super("glowing_hexorium_glass" + color.name, Optional.of(new HexStateMapper("glowing_hexorium_glass")), HexCreativeTabs.tabDecorative, Material.GLASS, color.color, HexFilters.filterContains("glowing_hexorium_glass_glow"));
