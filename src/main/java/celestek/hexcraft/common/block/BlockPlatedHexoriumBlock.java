...
public class BlockPlatedHexoriumBlock extends HexBlockReinforceable
{
	...
	{
		super("plated_hexorium_block_" + color.name, HexCreativeTabs.decorative, Material.IRON, color);
	...
	{
		return this.color.isSpecial() ? Optional.empty() : Optional.of(new HexStateMapper("plated_hexorium_block"));
	}
