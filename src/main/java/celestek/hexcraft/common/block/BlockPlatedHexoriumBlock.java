...
public class BlockPlatedHexoriumBlock extends HexBlockReinforceable
{
	...
	{
		super("plated_hexorium_block_" + color.name, color == EHexColors.RAINBOW ? Optional.empty() : Optional.of(new HexStateMapper("plated_hexorium_block")), HexCreativeTabs.tabDecorative, Material.IRON, color.color, HexFilters.CONTAINS_GLOW);
